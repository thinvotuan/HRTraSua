...
{
    public class PhuongPhapNhomDanhGia_ConController : ApplicationController
    {
        ...
        IList<sp_PhuongPhapNhomDanhGia_Index_ConResult> index;
        public const string taskIDSystem = "PPNhomDanhGia_Con";//REGWORKVOTE
        IList<sp_DanhMucNhomDanhGia_IndexResult> indexNhom;
        public bool? permission;

        tbl_DM_PhuongPhapNhomDanhGia_Con phuonPhapDG;
        //
        ...
        public ActionResult Index(int? page, int? pageSize, string searchString)
        {
            ...
            try
            {
                ...
                int? tongSoDong = 0;
                index = linqDM.sp_PhuongPhapNhomDanhGia_Index_Con(searchString, currentPageIndex, pageSize).ToList();
                try
                {
        ...
        public ActionResult Create()
        {
            ...
            try
            {
                phuonPhapDG = new tbl_DM_PhuongPhapNhomDanhGia_Con();
                phuonPhapDG.maPhuongPhapDanhGia = GenerateUtil.CheckLetter("PPNDGCon", GetMax());
        ...
        public ActionResult Create(FormCollection collection)
        {
            ...
            try
            {
                ...
                linqDM.tbl_DM_PhuongPhapNhomDanhGia_Cons.InsertOnSubmit(phuonPhapDG);
        ...
        public ActionResult Delete(string id)
        {
            try
            {
                ...
                var delete = linqDM.tbl_DM_PhuongPhapNhomDanhGia_Cons.Where(d => d.maPhuongPhapDanhGia == id);
                linqDM.tbl_DM_PhuongPhapNhomDanhGia_Cons.DeleteAllOnSubmit(delete);

                //Delete chi tiết
                var deleteCT = linqDM.tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Cons.Where(d => d.maPhuongPhapDanhGia == id);
                linqDM.tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Cons.DeleteAllOnSubmit(deleteCT);
                linqDM.SubmitChanges();
        ...
        public void BindDataToSave(FormCollection col, bool isCreate)
        {
            ...
            {
                phuonPhapDG = linqDM.tbl_DM_PhuongPhapNhomDanhGia_Cons.Where(d => d.maPhuongPhapDanhGia == col.Get("maPhuongPhapDanhGia")).FirstOrDefault();
            }
            ...
            var delNhomPhongBanChiTiet = linqDM.tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Cons.Where(d => d.maPhuongPhapDanhGia == col.Get("maPhuongPhapDanhGia"));
            linqDM.tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Cons.DeleteAllOnSubmit(delNhomPhongBanChiTiet);
            List<tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Con> ct = new List<tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Con>();
            tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Con danhGia;
            ...
            if (maNhomDanhGia != null)
            {
                for (int i = 0; i < maNhomDanhGia.Count(); i++)
                {
                    ...
                    danhGia = new tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Con();
                ...
                {
                    linqDM.tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Cons.InsertAllOnSubmit(ct);
                }
            }
        }
        ...
        {
            phuonPhapDG = linqDM.tbl_DM_PhuongPhapNhomDanhGia_Cons.Where(d => d.maPhuongPhapDanhGia == id).FirstOrDefault();
            ViewBag.TenNhanVien = HoVaTen(phuonPhapDG.nguoiLap);
            //Chi tiết qui trình duyệt
            ViewBag.ChiTiet = linqDM.tbl_DM_PhuongPhapNhomDanhGia_ChiTiet_Cons.Where(d => d.maPhuongPhapDanhGia == id).OrderBy(d=>d.thuHang).Select(d => new PhuongPhapDanhGiaChiTietModel
            {
        ...
        {
            return linqDM.tbl_DM_PhuongPhapNhomDanhGia_Cons.OrderByDescending(d=>d.ngayLap).Select(d => d.maPhuongPhapDanhGia).FirstOrDefault()??String.Empty;
        }
