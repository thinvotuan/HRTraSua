...
{
    public class PhieuDieuChuyenBoNhiemController : ApplicationController
    {
        ...
        public const string taskIDSystem = "PhieuDieuChuyenBN";//REGWORKVOTE
        ...
        public ActionResult Index(int? page, string searchString, string tuNgay, string denNgay, string trangThai)
        {
            ...
            ViewBag.isGet = "True";
            var tblPhieuDeNghis = lqPhieuDN.sp_NS_PhieuDangKyDieuChuyen_Index(trangThai, fromDate, toDate, searchString, GetUser().manv, "PhieuDieuChuyenBN").ToList();
        ...
        public ActionResult ViewIndex(int? page, string qSearch, string tuNgay, string denNgay, string trangThai)
        {
            ...
            ViewBag.isGet = "True";
            var tblPhieuDeNghis = lqPhieuDN.sp_NS_PhieuDangKyDieuChuyen_Index(trangThai, fromDate, toDate, qSearch, GetUser().manv, "PhieuDieuChuyenBN").ToList();
            int currentPageIndex = page.HasValue ? page.Value : 1;
            ViewBag.Count = tblPhieuDeNghis.Count();
        ...
        public ActionResult Create()
        {
            ...
            PhieuDeNghiModel.maPhieu = IdGenerator(); //GenerateUtil.CheckLetter("PDCBN", GetMax());
        ...
        public ActionResult Create(FormCollection coll)
        {
            try
            {
                ...
                tblPhieuDeNghi.soPhieu = IdGenerator(); //GenerateUtil.CheckLetter("PDCBN", GetMax());
                ...
                tblPhieuDeNghi.loaiDieuChuyen = "PhieuDieuChuyenBN";
        ...
        public ActionResult Edit(string id)
        {
            ...
            PhieuDeNghiModel.loaiDieuChuyen = "PhieuDieuChuyenBN";
        ...
        public string IdGenerator()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    return "PDCBN-" + nam + thang + sb.ToString();
                }
            }
        }
        ...
        public ActionResult In(string maPhieu)
        {
            ...
            return File(fileContent, "application/msword", "PhieuDieuChuyenBoNhiem" + ".doc");
        }
